...
from wtforms.fields import TextField, IntegerField, SelectField, FileField, PasswordField, BooleanField,StringField,SubmitField,TextAreaField
...
class ProfileForm(Form):
    ...
    email = StringField('Email Address', validators=[Length(min=6, max=100), Required("Required"), Email()])
